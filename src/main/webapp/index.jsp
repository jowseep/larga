...
<html>
  <head>
    ...
    <meta name="google-signin-client_id" content="34650846950-84j231ogscd1ucsa5dsu67em97lustuq.apps.googleusercontent.com">
  ...
  <body>
    <header>
      <nav>
        <ul class="nav-list">
          <li class="nav-list">
            <p><a href="<s:url action='book'/>" class="btn btn-outline-success">Book Now</a></p>
          </li>
        </ul>
      </nav>
    </header>
